...
SiteParam = collections.namedtuple(
    'SiteParam', 'lon lat depth z1pt0 z2pt5 vs30measured vs30 backarc liquefaction_susceptibility landsliding_susceptibility dw yield_acceleration cti dc dr dwb hwater precip'.split())


def site_param(z1pt0, z2pt5, vs30Type, vs30, lon, lat, depth=0,
